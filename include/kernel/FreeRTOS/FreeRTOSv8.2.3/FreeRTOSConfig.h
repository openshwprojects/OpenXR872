...
#ifdef __CONFIG_OS_FREERTOS_USE_IDLE_HOOK
#define configUSE_IDLE_HOOK                     1 /* not define vApplicationIdleHook when used cpuusage */
#else
#define configUSE_IDLE_HOOK                     0 /* not define vApplicationIdleHook when used cpuusage */
#endif
...
#if (defined(__CONFIG_BOOTLOADER) && !defined(__CONFIG_ROM_FREERTOS))
