...
/* Callback function prototypes. --------------------------*/
	...
	void rom_vApplicationStackOverflowHook(TaskHandle_t xTask, char *pcTaskName)
	{
	...
	UBaseType_t uxTask = 0;
		...
		if( listCURRENT_LIST_LENGTH( pxList ) > ( UBaseType_t ) 0 )
		{
			...
			do
			{
				...
				pxTaskStatusArray[ uxTask ].pxTopOfStack = pxNextTCB->pxTopOfStack;
...
/*-----------------------------------------------------------*/
	...
	char cStatus;
		...
		*pcWriteBuffer = 0x00;
#if configDEBUG_TRACE_TASK_MOREINFO
		#define TASK_INFO "Name\t\tState\tPri\tHWM\tIdx\tStkCur\tStkBot\r\n"
		sprintf( pcWriteBuffer, TASK_INFO);
...
#if configDEBUG_TRACE_TASK_MOREINFO
				sprintf( pcWriteBuffer, "\t%c\t%u\t%u\t%u\t%p\t%p\r\n", cStatus, ( unsigned int ) pxTaskStatusArray[ x ].uxCurrentPriority, ( unsigned int ) pxTaskStatusArray[ x ].usStackHighWaterMark, ( unsigned int ) pxTaskStatusArray[ x ].xTaskNumber, pxTaskStatusArray[ x ].pxTopOfStack, pxTaskStatusArray[ x ].pxStack);
#else
