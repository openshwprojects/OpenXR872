...
ifeq ($(__CONFIG_LWIP_VER_1_4_1), y)
  LWIP_DIR := lwip-1.4.1
else ifeq ($(__CONFIG_LWIP_VER_2_0_3), y)
  LWIP_DIR := lwip-2.0.3
else ifeq ($(__CONFIG_LWIP_VER_2_1_2), y)
  LWIP_DIR := lwip-2.1.2
endif
...
INCLUDE_PATHS += -I$(INCLUDE_ROOT_PATH)/net/nghttp2/$(NGHTTP2_DIR)/lib/includes
